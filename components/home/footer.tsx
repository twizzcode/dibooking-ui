...
// Data Link untuk bagian Footer (Company, Resources, Account)
...
export function Footer() {
  return (
    <div className="w-full border-t">
      <div className="max-w-(--breakpoint-xl) w-full mx-auto px-6 flex flex-col lg:gap-16 py-12 gap-12">
        <div className="grid grid-cols-1 items-center gap-12 text-center lg:grid-cols-5 lg:items-start lg:gap-6 lg:text-left">
          ...
          <div className="flex w-full flex-col items-center gap-6 pr-0 lg:col-span-2 lg:items-start lg:pr-12">
            ...
            <div className="flex flex-col gap-1 text-center lg:text-left">
              <h2 className="text-foreground text-base font-medium">Alamat:</h2>
            ...
            <div className="flex flex-col gap-1 text-center lg:text-left">
              ...
              <Link className="text-muted-foreground hover:text-foreground" href="mailto:info@example.com">
                twizzcode@gmail.com
              </Link>
              <Link className="text-muted-foreground hover:text-foreground" href="tel:+1234567890">
                +62 851-7444-6002
              </Link>
            </div>
          ...
          {/* Kolom Link Dinamis (Company, Resources, Account) */}
          {FOOTER_SECTIONS.map((section) => (
            <div key={section.title} className="flex flex-col gap-4">
              <h2 className="text-foreground text-base font-medium">{section.title}</h2>
              <nav className="flex flex-col gap-3" aria-label={`${section.title} links`}>
...
// Komponen Helper untuk Social Icon agar kode utama lebih bersih
