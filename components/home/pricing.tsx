...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen max-w-(--breakpoint-xl) w-full mx-auto flex flex-col items-center justify-center py-12 px-6">
      ...
      <p className="mt-3 text-xl text-center text-muted-foreground">
        Pilih paket yang sesuai dengan kebutuhan Anda dan mulai hari ini
      </p>
